...
const vehicleController = {
  ...
  processMaintenance: async (req, res) => {
    try {
      // 🛡️ SOLUCIÓN: Red de seguridad para capturar el ID del usuario correctamente y evitar el null
      let idUsuario = 1; // Valor por defecto de seguridad
      ...
      // 1. Guardamos la orden facturando exactamente los montos
      const nuevoMantenimiento = await db.Mantenimiento.create({
        id_vehiculo: req.body.id_vehiculo,
        id_usuario: idUsuario, // Ahora siempre será un número válido
        fecha_inicio: req.body.fecha_inicio,
        tipo_servicio: req.body.tipo_servicio,
        estado: req.body.estado,
        km_servicio: req.body.km_servicio,
        proximo_km: proxKm,
