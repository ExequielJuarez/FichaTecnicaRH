...
router.get(
  "/Vehicles/Editar/:id",
  authMiddleware,
  vehicleController.EditVehiculo,
);
router.post(
  "/Vehicles/Editar/:id",
  authMiddleware,
  vehicleController.processEditVehiculo,
);
...
router.post(
  "/Choferes/Carga",
  choferVAlidation(),
  choferController.processChofer,
);
...
router.get(
  "/Mantenimientos/carga/:id_vehiculo",
  authMiddleware,
